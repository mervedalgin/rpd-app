<<<<<<< HEAD
# rpd-app
🎓 Modern öğrenci yönlendirme sistemi - Next.js, Google Sheets ve Telegram entegrasyonu ile rehberlik süreçlerini dijitalleştiren web uygulaması
=======
...
>>>>>>> 43ef810 (Bağlantı ayarlandı, ilk gönderim)
